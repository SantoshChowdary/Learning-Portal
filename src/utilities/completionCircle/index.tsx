...
const CompletionCircle = (props : any) => {
    if (props.availability_status === "LOCKED"){
      ...
      return (
          <div className="circle" style={{backgroundImage : `radial-gradient(closest-side, white 79%, transparent 80% 100%), conic-gradient(rgb(40, 177, 40) ${props.completion_percentage}%, lightgrey 0)`}}>
          </div>
      )
    }
  }
